package com.lj.mcliu.util.QRCode;
...
public class QRUtil {
    ...
    public static void main(String[] args) {
        ...
        int height = 128;
        // 二维码存放地址
        String imagePath = "src/main/webapp/resources/img/qrcode/qr_code.png";
...
//        String waterImgPath = QRUtil.resizeImg("d:/zbl.png", width / 6, height / 6, true);
//
//        // d:/qr/qr_bg.png这种图片是自己画好边框光晕效果的边框底图
//        String tempImg = QRUtil.addWaterBorder(waterImgPath, "d:/qr_bg.png");
//
