...
<link rel="icon" href="/mcliu/resources/img/favicon/icon.ico" type="image/vnd.microsoft.icon">
<link rel="shortcut icon" href="/mcliu/resources/img/favicon/icon.ico" type="image/vnd.microsoft.icon">
