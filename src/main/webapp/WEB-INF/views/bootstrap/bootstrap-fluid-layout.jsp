...
<link href="/resources/css/bootstrap/example-fluid-layout.css" rel="stylesheet">
...
<script type="text/javascript"
	src="/resources/js/bootstrap/bootstrap-fluid-layout.js"></script>
</head>
		...
		<div class="modal-body padding0">
			...
			<div id="myCarousel" class="carousel slide myCarousel">
				...
				<div class="carousel-inner">
					<div class="item">
						<img src="/resources/img/bootstrap/Skiing.jpg" alt="">
					...
					<div class="item">
						<img src="/resources/img/bootstrap/GSZ.jpg" alt="">
						<div class="carousel-caption">
							<h4>铁岭拓展训练</h4>
					...
					<div class="item active">
						<img src="/resources/img/bootstrap/FHS.jpg" alt="">
						<div class="carousel-caption">
							<h4>丹东凤凰山</h4>
							<p>猛然间，我又相信爱情了。</p>
						</div>
